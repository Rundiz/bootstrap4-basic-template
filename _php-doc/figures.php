                ...
                <div class="row">
                    <article class="col-12">
                        ...
                        <div class="example-block">
                            <figure class="figure">
                                <img src="img/sample-300x250.jpg" class="figure-img img-fluid rounded" alt="A generic square placeholder image with rounded corners in a figure.">
